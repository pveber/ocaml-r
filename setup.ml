...
(* OASIS_START *)
(* DO NOT EDIT (digest: aaaad4b3bea0819eef16fdef2cd8860c) *)
(*
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rbase"];
                      lib_internal_modules = ["Date"; "Listing"; "Dataframe"];
                      lib_findlib_parent = Some "R";
